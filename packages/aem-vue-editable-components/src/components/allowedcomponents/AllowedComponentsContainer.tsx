...
import { Prop, Vue, mixins, Component, toNative } from "vue-facing-decorator";
import { Container } from "../Container";
import { AllowedComponentsPlaceholderList } from "./AllowedComponentsPlaceholderList";
...
export class AllowedComponentsPropertiesMixin extends Vue {
  @Prop({ default: "No allowed components" })
...
class AllowedComponentsContainerClass extends mixins(
...
export const AllowedComponentsContainer = toNative(
  AllowedComponentsContainerClass
);
