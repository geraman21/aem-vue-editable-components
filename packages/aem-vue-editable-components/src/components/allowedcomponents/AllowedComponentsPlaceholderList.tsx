...
import { AllowedComponentsPlaceholder } from "./AllowedComponentsPlaceholder";
 ...
 * @private
 */
export interface AllowedComponentsPlaceholderListProperties {
  title: string;
  emptyLabel: string;
...
class AllowedComponentsPlaceholderListClass extends Vue {
...
export const AllowedComponentsPlaceholderList = toNative(
  AllowedComponentsPlaceholderListClass
);
